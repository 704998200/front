...
module.exports = configure(function (ctx) {
  return {
    ...
    bin: {
      linuxAndroidStudio:
        "/data/JetBrains/apps/AndroidStudio/ch-0/203.7321754/bin/studio.sh",
    },
    ...
    pwa: {
      ...
      // for the custom service worker ONLY (/src-pw````````````  qA    A      a/custom-service-worker.[js|ts])
