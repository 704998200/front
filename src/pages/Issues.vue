      ...
      <q-page>
        <div class="q-pa-md" style="width: 100%; max-height: 50%">
          <q-list bordered separator>
            <q-item v-ripple clickable v-for="issue in issues">
